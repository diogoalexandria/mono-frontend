import { Button, MenuItem, Paper, TextField, Typography, makeStyles } from '@material-ui/core';
                        ...
                        <React.Fragment>
                            <Grid container spacing={3}>
                                <Grid item xs={12}>
                                    ...
                                    >
                                        {classesInfo.map((class_item) => (
                                            class_item ?
                                                <MenuItem key={class_item.value} value={class_item.value}>
                                                    {class_item.label}
                                                </MenuItem> :
                                                <div></div>
                                        ))}
